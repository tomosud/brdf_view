#version 300 es
// Image Slice. Ported to GLSL ES 3.00 from brdftemplateImageSlice.frag.
// x = thetaH (half angle), y = thetaD (difference angle), both [0, pi/2]; the
// BRDF (analytic or measured) is evaluated for the synthesized L/V at a fixed
// phiD. Copyright Disney Enterprises, Inc. (original template). See public/LICENSE.
